        ...
        <div class="container py-5">
          ...
          <div class="row text-center display-flex">
            ...
            src={foto3} alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"/>
                <h5 class="mb-0">Frederick Cid</h5><span class="small text-uppercase text-muted">Full stack developer</span>
                <ul class="social mb-0 list-inline mt-3">
           ...
           {/*  <!-- Team item--> */}
            <div class="col-xl-3 col-sm-6 mb-5">
              ...
              src={foto4} alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"/>
                <h5 class="mb-0">Tamara Verdugo</h5><span class="small text-uppercase text-muted">Full stack developer</span>
                <ul class="social mb-0 list-inline mt-3">
           ...
           <div class="col-xl-3 col-sm-6 mb-5">
              <div class="bg-white rounded shadow-sm py-5 px-4">
                ...
                <h5 class="mb-0">Ricardo Carrizo</h5><span class="small text-uppercase text-muted">Full stack developer</span>
                <ul class="social mb-0 list-inline mt-3">
